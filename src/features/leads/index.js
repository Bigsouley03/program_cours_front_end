...
const TopSideButtons = () => {
    ...
    const openAddNewLeadModal = () => {
        dispatch(openModal({title : "Ajouter un semestre", bodyType : MODAL_BODY_TYPES.LEAD_ADD_NEW}))
    }

    return(
        <div className="inline-block float-right">
            <button className="btn px-6 btn-sm normal-case btn-primary" onClick={() => openAddNewLeadModal()}>Ajouter Semestre</button>
        </div>
    )
}
                                ...
                                return(
                                    ...
                                    <td>
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <div className="font-bold">{l.semestre_name}</div>
